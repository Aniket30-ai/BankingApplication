...
public class JwtUtil {
	...
	private String createToken(Map<String, Object> claims, String email, String roles) {
		return Jwts.builder().setClaims(claims).setSubject(email).claim("roles", roles) // Store roles inside JWT
	...
	public List<String> extractRoles(String token) {
		...
		if (roleClaim instanceof String role) {
			...
			return ((List<?>) roleClaim).stream().map(Object::toString).collect(Collectors.toCollection(ArrayList::new));
		}
