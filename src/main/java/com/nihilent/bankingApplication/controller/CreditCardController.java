...
public class CreditCardController {
	...
	public ResponseEntity<String> apply(
		...
		return new ResponseEntity<String>(applyForCard, HttpStatus.CREATED);
	}
	...
	public ResponseEntity<List<CreditCard>> getPendingRequests() throws NihilentBankException {
		...
		return new ResponseEntity<List<CreditCard>>(pendingRequests, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> approve(@PathVariable Long id) throws NihilentBankException {
		...
		return new ResponseEntity<String>(approveRequest, HttpStatus.OK);
	}
